...
$woordenLijst = ["PROGRAMMING", "DEVELOPER", "KEYBOARD", "INTERNET", "SOFTWARE", "DATABASE", "ALGORITHM", "VARIABLE", "FUNCTION", "INTERFACE"];
...
<body class="bg-[#0f172a] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-2xl w-full">
        ...
        <?php else: ?>
            <div class="bg-white rounded-[3rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden transform transition-all">
                <div class="p-10 text-center">
                    ...
                    <div class="bg-indigo-50/50 rounded-[2rem] p-8 mb-10 flex justify-center border border-indigo-100/50 relative">
                        <svg width="180" height="180" viewBox="0 0 150 200">
                            <?php if ($_SESSION['fouten'] >= 1): ?>
                                <line class="draw-anim" x1="20" y1="180" x2="130" y2="180" stroke="#1e293b" stroke-width="8" stroke-linecap="round" /> <?php endif; ?>
                            <?php if ($_SESSION['fouten'] >= 2): ?>
                                <line class="draw-anim" x1="40" y1="180" x2="40" y2="20" stroke="#1e293b" stroke-width="8" stroke-linecap="round" /> <?php endif; ?>
                            <?php if ($_SESSION['fouten'] >= 3): ?>
                                <line class="draw-anim" x1="40" y1="20" x2="120" y2="20" stroke="#1e293b" stroke-width="8" stroke-linecap="round" /> <?php endif; ?>
                            <?php if ($_SESSION['fouten'] >= 4): ?>
                                <line class="draw-anim" x1="40" y1="60" x2="80" y2="20" stroke="#1e293b" stroke-width="6" stroke-linecap="round" /> <?php endif; ?>
                            <?php if ($_SESSION['fouten'] >= 5): ?>
                                <line class="draw-anim" x1="120" y1="20" x2="120" y2="50" stroke="#6366f1" stroke-width="4" /> <?php endif; ?>
                            <?php if ($_SESSION['fouten'] >= 6): ?>
                                <circle class="draw-anim" cx="120" cy="75" r="20" stroke="#1e293b" stroke-width="6" fill="white" /> <?php endif; ?>
                            <?php if ($_SESSION['fouten'] >= 7): ?>
                                <line class="draw-anim" x1="120" y1="95" x2="120" y2="140" stroke="#1e293b" stroke-width="6" stroke-linecap="round" /> <?php endif; ?>
                            ...
                            <?php if ($_SESSION['fouten'] >= 9): ?>
                                <line class="draw-anim" x1="120" y1="140" x2="100" y2="175" stroke="#1e293b" stroke-width="6" stroke-linecap="round" /> <?php endif; ?>
                    ...
                    <div class="mb-12">
                        <div class="text-5xl font-black tracking-[0.3em] text-slate-800 mb-6 font-mono break-all leading-tight">
                            <?php echo $weergaveWoord; ?>
                        </div>
                        <div class="flex justify-center flex-wrap gap-3">
                            <?php foreach ($_SESSION['foute_letters'] as $fout): ?>
                                <span class="bg-red-50 text-red-500 px-4 py-2 rounded-xl text-sm font-black border border-red-100 animate-pulse"><?php echo $fout; ?></span>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <?php if ($gewonnen): ?>
                        <div class="bg-emerald-50 border-2 border-emerald-100 p-8 rounded-[2rem] mb-6">
                            ...
                            <a href="galgje.php?reset=1" class="inline-block mt-4 bg-emerald-600 text-white px-10 py-4 rounded-2xl font-black hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-500/20 uppercase">Next Round</a>
                        </div>
                    <?php elseif ($verloren): ?>
                        <div class="bg-rose-50 border-2 border-rose-100 p-8 rounded-[2rem] mb-6">
                            ...
                            <a href="galgje.php?reset=1" class="inline-block bg-rose-600 text-white px-10 py-4 rounded-2xl font-black hover:bg-rose-500 transition-all shadow-lg shadow-rose-500/20 uppercase">Try Again</a>
                        </div>
                    <?php else: ?>
                        <div class="grid grid-cols-7 md:grid-cols-9 gap-3">
                            ...
                            foreach (range('A', 'Z') as $char) {
                                ...
                                if ($isUsed) {
                                    ...
                                    echo "<a href='galgje.php?letter=$char' class='letter-btn h-12 flex items-center justify-center rounded-xl bg-slate-800 text-white font-black hover:bg-indigo-600 hover:shadow-xl hover:shadow-indigo-500/30 transform active:scale-90 border-b-4 border-slate-900'>$char</a>";
                                }
                            }
                            ?>
                        </div>
        ...
        <div class="flex justify-between items-center mt-10 px-4">
            <a href="galgje.php?reset=1" class="text-slate-400 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest">Quit Game</a>
        </div>
    </div>
